...
import { OMNIDEF } from './rohithDemoEnglish_def.js';
import tmpl from './rohithDemoEnglish.html';
import tmpl_nds from './rohithDemoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class rohithDemoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
