...
import { OMNIDEF } from './newtestTest2English_def.js';
import tmpl from './newtestTest2English.html';
import tmpl_nds from './newtestTest2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class newtestTest2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
