...
import { OMNIDEF } from './newtestTest1English_def.js';
import tmpl from './newtestTest1English.html';
import tmpl_nds from './newtestTest1English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class newtestTest1English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
