...
import { OMNIDEF } from './remoteTestTesting1English_def.js';
import tmpl from './remoteTestTesting1English.html';
import tmpl_nds from './remoteTestTesting1English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class remoteTestTesting1English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
